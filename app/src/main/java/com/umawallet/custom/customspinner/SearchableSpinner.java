...
public class SearchableSpinner extends Spinner implements View.OnTouchListener,
    ...
    private List _items;
    public static TextView txthint;
    ...
    private void init() {
        ...
        if (!TextUtils.isEmpty(_strHintText)) {
            ArrayAdapter arrayAdapter = new ArrayAdapter(_context, R.layout
                    .spinner_hint_text, R.id.txthint, new String[]{_strHintText});
            _isFromInit = true;
    ...
    public boolean onTouch(View v, MotionEvent event) {
        if (event.getAction() == MotionEvent.ACTION_UP) {
            ...
            if (null != _arrayAdapter) {
                ...
                // Refresh content #6
                // Change Start
                // Description: The mOrignalitems were only set initially, not reloading the data in the
                // spinner every time it is loaded with mOrignalitems in the adapter.
                _items.clear();
